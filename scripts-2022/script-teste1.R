...
filesWave <- list.files("D:/dados-audiomoth-2022/pasta-teste", pattern="*.WAV", full.names=TRUE)
#####################################################################################################################################

## insira o diret?rio onde deseja salvar o output:####################################################################################
setwd("D:/dados-audiomoth-2022/analises")
#####################################################################################################################################
...
mediasdindices <- mediaedphoraACI
