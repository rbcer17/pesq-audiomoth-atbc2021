...
filesWave <- list.files("C:/Users/mathe/Documents/02.2020/Estágio laBio/Gravações_Nicole_jul2020", pattern="*.WAV", full.names=TRUE)##Substitua o endereço

sndcupimco1 <- readWave(filesWave[1])
acicupimco1 <- acoustic_complexity(sndcupimco1, min_freq = NA, max_freq = NA, j = 5, fft_w = 512)
filesWave[1] <- sub("C:/Users/mathe/Documents/02.2020/Estágio laBio/Gravações_Nicole_jul2020/","",filesWave[1])##Substitua o endereço, acrescente uma "/"
...
acicupimco1 <- acoustic_complexity(sndcupimco1, min_freq = NA, max_freq = NA, j = 5, fft_w = 512)
filesWave[i] <- sub("C:/Users/mathe/Documents/02.2020/Estágio laBio/Gravações_Nicole_jul2020/","",filesWave[i])##Substitua o endereço, acrescente uma "/"
